...
Jobs:
  1. build → 2. infrastructure (Bicep) → 3. deploy (Azure Web Apps)
```
...
*This document serves as the authoritative technology reference for the Content Creation Platform.*
